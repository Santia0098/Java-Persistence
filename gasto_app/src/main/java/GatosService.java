...
public class GatosService {
    ...
    .build();
        ...
        elJson.substring(1, elJson.length());
        elJson.substring(0, elJson.length() - 1);
        ...
        try {
            ...
            if(fondoGato.getIconWidth() > 800) {
                ...
                Image modif = fondo.getScaledInstance(800, 600, java.awt.Image.SCALE_SMOOTH);
                fondoGato = new ImageIcon(modif);
...
Request request = new Request.Builder()
  ...
  .addHeader("x-api-key", "ecf9aec8-9b52-4661-bc21-b77ae9a76e1b")
  .build();
Response response = client.newCall(request).execute();
        } catch (Exception e) {
        }
